...
class MsCompany(models.Model):
    ...
    def insertData(self, compName, compAddress):
...
class Job(models.Model):
    ...
    def insertData(self, inpName, jobRole, jobSalary, jobDescription):
...
class Project(models.Model):
    ...
    def insertData(self, projectTitle, projectDeadline, projectWage, projectDescription):
